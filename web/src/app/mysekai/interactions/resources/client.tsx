...
function ResourcesContent() {
    ...
    const href = region ? interactionHref({ region, snapshot: snapshot && /^[a-z0-9][a-z0-9._-]{0,95}$/.test(snapshot) ? snapshot : undefined }) : "/mysekai/interactions/";
    return <main className="mysekai-interactions">
        ...
        <ResourceCachePanel playerOpen={false} reloadHref={href} />
    </main>;
}
